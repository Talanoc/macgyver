...
from constants import (needle, syringe, ether, macgyver, wall,
                       victoire, rip, size, floor)
...
class Macgyver:
    ...
    check that movement is possible
        ...
        __soustrait le step_value de la position_macgyver(retour à la
        position d'origine)
    '''
    ...
    assignment of variables according to the old and new position
        ...
        (old_position=0 au départ du jeu-> index =-1 ->derniere
        case de la liste)
    '''
